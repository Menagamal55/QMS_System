...
class Open_account extends StatelessWidget {
    ...
    return BlocProvider(
      ...
      child: BlocBuilder<CustomerCubit, CustomerState>(
        builder: (context, state) {
          final serviceName = ModalRoute.of(context)?.settings.arguments as String? ?? "Open Account";
                ...
                children: [
                  ...
                  Expanded(
                    child: ListView(
                      ...
                      children: [
                        _buildSelectionCard(label: "Service", value: serviceName, iconData: Icons.person_add_alt_1_rounded, isActive: true),
                        const Gap(15),
                        _buildSelectionCard(label: "Branch", value: "Mansoura Main Branch", iconData: Icons.location_on_rounded, isActive: false),
                        const Gap(25),
                        ClipRRect(
  ...
  Widget _buildSelectionCard({required String label, required String value, required IconData iconData, required bool isActive}) {
    return Container(
  ...
  Widget _buildStatBox({required Color color, required IconData icon, required String label, required String value}) {
    return Expanded(
      child: Container(
        height: 90,
        color: color,
